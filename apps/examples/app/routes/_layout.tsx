...
import { Outlet, useSearchParams, Link as RemixLink, useLocation } from "react-router";
    ...
    <>
      ...
      {preview && (
        <>
          <Navbar.LinkItem asChild>
            <RemixLink
              to={{
                pathname: pathWithTheme("/mdx-test", activeTheme),
              }}
            >
              Docs
              <Navbar.ItemIcon>
          ...
          <Navbar.LinkItem asChild>
            <RemixLink
              to={{
                pathname: pathWithTheme("/figma-test", activeTheme),
              }}
            >
              Figma
              <Navbar.ItemIcon>
      ...
      <Navbar.Item>
        <Button variant="primary-outline" size="small" asChild>
          <RemixLink to={{ pathname: pathWithTheme(location.pathname, nextTheme) }}>
