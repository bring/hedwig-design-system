  ...
  forwardRef(({ as: Component = "button", children, className, onClick, ...rest }, ref) => {
    ...
    return (
      <Component
        ...
        type="button"
      >
        <span className={clsx("hds-accordion-item-header--icon")}>
          <svg
            fill="none"
            height="24"
            viewBox="0 0 24 24"
          ...
          >
            <g className="hds-accordion-item-header--icon-chevron">
              <path
                className="hds-accordion-item-header--icon-chevron_down"
