...
- 4f5ddcf: fix: prevent close button overlapping long text

## 4.2.1

### Patch Changes

- Updated dependencies [b6143e9]
  - @postenbring/hedwig-tokens@3.1.0
...
- 4bdc89b: Center stand-alone body action on miniature card vertically

## 3.0.1

### Patch Changes

- 009caa1: Remove margin-right from miniature card media
